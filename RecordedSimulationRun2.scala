...
class RecordedSimulationRun2 extends Simulation {
	...
	setUp(User1.inject(atOnceUsers(1)),User2.inject(atOnceUsers(1)),User3.inject(atOnceUsers(1)),User4.inject(atOnceUsers(1)),
